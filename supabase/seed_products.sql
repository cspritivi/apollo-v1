...
-- - product_options.product_id links each option to its parent product,
--   ensuring options like "pocket_style" are scoped per product.
-- - UUIDs are generated automatically via gen_random_uuid().
--
-- WHY A CTE FOR PRODUCT INSERTS:
-- product_options requires a product_id FK. Since products use auto-generated
-- UUIDs, we INSERT the products in a CTE with RETURNING to capture the IDs,
-- then reference them by name when inserting options.
-- =============================================================================

-- Insert products and capture their generated IDs for use in option inserts.
...
-- Extract individual product IDs by name for readable option inserts.
suit AS (SELECT id FROM inserted_products WHERE name = 'Two-Piece Suit'),
shirt AS (SELECT id FROM inserted_products WHERE name = 'Dress Shirt'),
trouser AS (SELECT id FROM inserted_products WHERE name = 'Trousers')

-- =============================================================================
-- PRODUCT OPTIONS
-- =============================================================================

INSERT INTO product_options (product_id, option_group, name, description, image_url, price_modifier, available)
VALUES
...
-- Lapel Style
  ((SELECT id FROM suit), 'lapel_style', 'Notch Lapel',
  ...
  ((SELECT id FROM suit), 'lapel_style', 'Peak Lapel',
  ...
  ((SELECT id FROM suit), 'lapel_style', 'Shawl Lapel',
...
-- Button Count
  ((SELECT id FROM suit), 'button_count', 'One Button',
  ...
  ((SELECT id FROM suit), 'button_count', 'Two Button',
  ...
  ((SELECT id FROM suit), 'button_count', 'Three Button',
...
-- Vent Style
  ((SELECT id FROM suit), 'vent_style', 'No Vent',
  ...
  ((SELECT id FROM suit), 'vent_style', 'Single Vent',
  ...
  ((SELECT id FROM suit), 'vent_style', 'Double Vent',
...
-- Lining Style
  ((SELECT id FROM suit), 'lining_style', 'Full Lining',
  ...
  ((SELECT id FROM suit), 'lining_style', 'Half Lining',
  ...
  ((SELECT id FROM suit), 'lining_style', 'Unlined',
...
-- Pocket Style (Suit)
  ((SELECT id FROM suit), 'pocket_style', 'Flap Pocket',
  ...
  ((SELECT id FROM suit), 'pocket_style', 'Welt Pocket',
  ...
  ((SELECT id FROM suit), 'pocket_style', 'Patch Pocket',
...
-- Collar Style
  ((SELECT id FROM shirt), 'collar_style', 'Spread Collar',
  ...
  ((SELECT id FROM shirt), 'collar_style', 'Button-Down',
  ...
  ((SELECT id FROM shirt), 'collar_style', 'Mandarin',
  ...
  ((SELECT id FROM shirt), 'collar_style', 'Cutaway',
...
-- Cuff Style
  ((SELECT id FROM shirt), 'cuff_style', 'Barrel Cuff',
  ...
  ((SELECT id FROM shirt), 'cuff_style', 'French Cuff',
  ...
  ((SELECT id FROM shirt), 'cuff_style', 'Convertible Cuff',
...
-- Placket Style
  ((SELECT id FROM shirt), 'placket_style', 'Standard Placket',
  ...
  ((SELECT id FROM shirt), 'placket_style', 'French Placket',
...
-- Pocket Style (Shirt)
  ((SELECT id FROM shirt), 'pocket_style', 'No Pocket',
  ...
  ((SELECT id FROM shirt), 'pocket_style', 'Chest Pocket',
...
-- Back Pleat
  ((SELECT id FROM shirt), 'back_pleat', 'No Pleat',
  ...
  ((SELECT id FROM shirt), 'back_pleat', 'Box Pleat',
  ...
  ((SELECT id FROM shirt), 'back_pleat', 'Side Pleats',
...
-- Fit Style
  ((SELECT id FROM trouser), 'fit_style', 'Slim Fit',
  ...
  ((SELECT id FROM trouser), 'fit_style', 'Regular Fit',
  ...
  ((SELECT id FROM trouser), 'fit_style', 'Relaxed Fit',
...
-- Pleat Style
  ((SELECT id FROM trouser), 'pleat_style', 'Flat Front',
  ...
  ((SELECT id FROM trouser), 'pleat_style', 'Single Pleat',
  ...
  ((SELECT id FROM trouser), 'pleat_style', 'Double Pleat',
...
-- Hem Style
  ((SELECT id FROM trouser), 'hem_style', 'Plain Hem',
  ...
  ((SELECT id FROM trouser), 'hem_style', 'Cuffed Hem',
  ...
  ((SELECT id FROM trouser), 'hem_style', 'Tapered Hem',
...
-- Pocket Style (Trousers)
  ((SELECT id FROM trouser), 'pocket_style', 'Slant Pocket',
  ...
  ((SELECT id FROM trouser), 'pocket_style', 'Vertical Pocket',
...
-- Waistband Style
  ((SELECT id FROM trouser), 'waistband_style', 'Standard Waistband',
  ...
  ((SELECT id FROM trouser), 'waistband_style', 'Extended Waistband',
